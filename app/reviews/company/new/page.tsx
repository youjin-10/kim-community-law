...
export default async function NewCompanyReviewPage() {
  ...
  if (!user) {
    return redirect("/login?next=/reviews/company/new");
  }
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <Card className="max-w-2xl mx-auto">
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">Submit a Company Review</CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-center text-gray-600 mb-6">
            Share your experience working at this company to help others make informed decisions.
          </p>
          <CompanyReviewForm />
        </CardContent>
      </Card>
